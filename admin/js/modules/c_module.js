+(function (angular) {
    var moduleName = "c_module",
        c_module = angular.module(moduleName, ["ui.bootstrap", 'ngAnimate', 'angular-loading-bar', 'ngMessages', 'fileUpload', 'validation', 'myfilters'], function ($httpProvider) {
    ...
    //c_module.constant('config', config || {});
    window.CSystem = {};
