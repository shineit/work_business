(function($,dialog) {
	...
	var img_upload_url = config.DIRECT_DTRES_ROOT + "/album/upload";
	...
	UploadImg.prototype = {
		initUploadImg : function() {
            ...
            var settings = {
                ...
                button_width: $el.innerWidth(),
                button_height: $el.innerHeight(),
        ...
        setFileUploadLimit:function(limit){
            ...
            this.swfupload.setFileQueueLimit(limit);
        },
        ...
        decreaseUploadLimit:function(){
            this.setFileUploadLimit(this.getFileUploadLimit()-1);
        }
	};

	window.xm.UploadImg = UploadImg;

})(jQuery,window.xm.plugin);